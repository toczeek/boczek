...
public class VelocimeterView extends View {
    ...
    private DigitalBlurImp digitalBlurPainter;
    private int min = 0;
    ...
    public void setUnits(Context context, String units) {
        this.units = units;
        digitalPainter.setUnits(this.units);
        digitalBlurPainter.setUnits(this.units);
    }
